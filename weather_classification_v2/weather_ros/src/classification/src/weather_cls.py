...
def test(img, size_x, size_y, suncloud_wght, sunrain_wght, cloudrain_wght, 
    ...
    hga_feat, avg_hga = features.calc_hga(img)
    hsv_feat, avg_hsv = features.calc_HSV(img)
    roi_feat, avg_roi = features.calc_roi(img)
    ...
    cv2.putText(img_show, 'ROI: {:.3f}'.format(avg_roi), (15, 630), cv2.FONT_HERSHEY_SIMPLEX, 
                0.7, (255,0,0), 1, cv2.LINE_AA)
    cv2.putText(img_show, 'HGA: {:.3f}'.format(avg_hga), (15, 660), cv2.FONT_HERSHEY_SIMPLEX, 
                0.7, (255,0,0), 1, cv2.LINE_AA)
    cv2.putText(img_show, 'HSV: {:.3f}'.format(avg_hsv), (15, 690), cv2.FONT_HERSHEY_SIMPLEX, 
                0.7, (255,0,0), 1, cv2.LINE_AA)
...
def adastec_cls(dash_img):
    ...
    cv2.putText(img_show, 'FPS: {:.3f}'.format(fps), (820, 40), cv2.FONT_HERSHEY_SIMPLEX, 

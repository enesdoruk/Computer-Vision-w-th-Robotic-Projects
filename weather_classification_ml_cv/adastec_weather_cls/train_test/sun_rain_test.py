...
def sun_rain_test():
    categories = {-1: 'sun',  1: 'rainy'}

    img = cv2.imread(os.path.expanduser('~') + '/Desktop/weather_classification/adastec_weather_cls/dataset/img/Rainy/88427.jpg')
    ...
    filename = os.path.expanduser('~') + '/Desktop/weather_classification/adastec_weather_cls/weights/sun_rain_wghts_adabostDT.sav'
    ...
    global_feature = np.hstack([hga_feat, hsv_feat])

...
def sun_cloud_test():
    categories = {1: 'cloud',  -1: 'sun'}

    img = cv2.imread(os.path.expanduser('~') + '/Desktop/weather_classification/adastec_weather_cls/dataset/img/Cloudy/86212.jpg')
    ...
    filename = os.path.expanduser('~') +  '/Desktop/weather_classification/adastec_weather_cls/weights/sun_cloud_wghts_adabostDT.sav'
